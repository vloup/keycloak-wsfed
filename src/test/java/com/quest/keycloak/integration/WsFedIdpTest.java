...
public class WsFedIdpTest extends AbstractWsFedAuthTest {
    ...
    public void testNominalCaseWithSaml2() throws Exception {
        ...
        RequestSecurityTokenResponse rstr = parseRstToken(wsFedResponse);
        ...
        assertThat(AssertionUtil.isSignatureValid(assertion, parseCertificate(IDP_CERT_BASE64).getPublicKey()), equalTo(true));
    }
    ...
    public void testNominalCaseWithSaml1() throws Exception {
        ...
        org.w3c.dom.Document d = token.createXmlDocument(wsFedResponse);
        org.w3c.dom.Element assertion = token.extractSamlDocument(d).getDocumentElement();
        assertThat(SAML11RequestedToken.isSignatureValid(assertion, parseCertificate(IDP_CERT_BASE64).getPublicKey()), equalTo(true));
    }

    private RequestSecurityTokenResponse parseRstToken(String tokenString) {
